 ...
 *
 * @version Main.java
 * @version Created on 13/06/2010, 23:34:08
 * @author justomiguel
 */
public class Main extends AbstractPageBean {
    ...
    public String button1_action() {
       /* try {
            ...
            label10.setText("No se ha podido acceder a los beans...");
        }
        if (localidades != null) {
            boolean crear = localidades.create(Integer.parseInt(id_name.getText().toString()), nombre_pro.getText().toString(), Integer.parseInt(codpostal.getText().toString()), Integer.parseInt(codarea.getText().toString()));
            if (crear) {
                label10.setText("La Localidad se ha creado correctamente...");
            } else {
                label10.setText("La localidad ya existe...");
            }
        }*/
        return null;
    }
