 ...
 *
 * @version Index.java
 * @version Created on 13/06/2010, 15:12:53
 * @author justomiguel
 */
...
public class Index extends AbstractPageBean {
    ...
    public void setNombreLabel(Label l) {
        this.nombreLabel = l;
    }
    ...
    public String button1_action() {
        try {
            FTPRemote ftp = (FTPRemote) sl.lookup(FTPRemote.class.getName());
            ftp.uploadFileByFTP("192.168.17.101", "webmaster", "tito", "/home/justomiguel/Imágenes/Fotos/midir.txt", "/var/www/cliente/ftp_server/midir.txt");
